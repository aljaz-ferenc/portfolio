...
var mouseHighlightEl = document.querySelector('.mouse-highlight');
var aboutMeLink = document.querySelector('.about-link');
var workLink = document.querySelector('.work-link');
var contactLink = document.querySelector('.contact-link');
var aboutSection = document.querySelector('.hero');
